...
```
config.py ← io_utils.py, data_panel.py, universe.py, signal.py, metrics.py, backtest.py
data_panel.py ← universe.py, backtest.py, run_all.py
signal.py ← selector_classic.py, selector_ae.py, selector_gru.py, backtest.py
encoder_ae.py ← selector_ae.py
encoder_gru.py ← selector_gru.py
selector_ae.py ← selector_gru.py (reuses _knn_candidates)
